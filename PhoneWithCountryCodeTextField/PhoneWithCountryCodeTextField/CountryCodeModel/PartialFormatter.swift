...
public final class PartialFormatter {
    ...
    func createFormattingTemplate(_ format: MetadataPhoneNumberFormat, rawNumber: String) -> String? {
        ...
        numberPattern = characterClassRegex.stringByReplacingMatches(in: numberPattern, range: .init(location: 0, length: numberPattern.count), withTemplate: "\\\\d")
        numberPattern = standaloneDigitRegex.stringByReplacingMatches(in: numberPattern, range: .init(location: 0, length: numberPattern.count), withTemplate: "\\\\d")
